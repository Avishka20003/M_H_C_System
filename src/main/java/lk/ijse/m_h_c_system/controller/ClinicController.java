...
import lk.ijse.m_h_c_system.model.ClinicModel;
...
public class ClinicController implements Initializable {
    ...
    public void btnChildAddOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isInsert = clinicModel.addClinic(clinicDto);
            if (isInsert) {
                reset();
    ...
    public void deleteClinic(String clinicId) {
        ...
        if (result.get() == ButtonType.OK) {
            try {
                boolean isDeleted = clinicModel.DeleteClinic(clinicId);
                if (isDeleted) {
                    reset();
    ...
    public void btnClinicUpdateOnAction(ActionEvent actionEvent) {
       ...
       String description = txtDescription.getText();
        ...
        try{
            boolean isUpdated = clinicModel.update(clinicDto);
            if (isUpdated) {
                reset();
